...
namespace PowerliftingSimulator.Squat
{
    ...
    public static class SquatTelemetrySchema
    {
        ...
        private static SquatTelemetryChannelDescriptor[] CreateDescriptors()
        {
            ...
            Set(descriptors, SquatTelemetryChannelId.DepthLandmarksAvailability, "depth_landmarks_available", "bool", SquatTelemetryFrame.WORLD, SquatTelemetrySourceClass.ENGINEERING_DERIVED, SquatTelemetryAvailabilitySemantics.REQUIRED, "Availability of shared GAM-10 pelvis/shank-frame surface-proxy landmarks.");
            ...
            Set(descriptors, SquatTelemetryChannelId.DepthMarginM, "depth_game_judgment_margin_m", "m", SquatTelemetryFrame.WORLD, SquatTelemetrySourceClass.GAME_MODEL, SquatTelemetryAvailabilitySemantics.REQUIRED, "GAME_JUDGMENT_MARGIN_M=0.005; a deterministic game threshold, not an IPF-prescribed distance.");
            ...
            Set(descriptors, SquatTelemetryChannelId.SupportContactCount, "support_contact_count", "count", SquatTelemetryFrame.WORLD, SquatTelemetrySourceClass.ENGINE_RUNTIME_OBSERVATION, SquatTelemetryAvailabilitySemantics.EXPLICIT_NOT_AVAILABLE, "Count of active support geometry points; per-step plantar manifold and impulse buffers remain separate foot telemetry.");
